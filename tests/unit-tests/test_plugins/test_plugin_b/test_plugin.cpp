...
namespace yoyo::test
{
class test_gui_node_b : public gui_node
{
  Q_OBJECT
...
class test_data_node_b : public data_node
{
  Q_OBJECT
...
class test_protocol_node_b : public protocol_node
{
  Q_OBJECT
...
class test_communication_node_b : public communication_node
{
  Q_OBJECT
  auto staticTypeId() const -> boost::uuids::uuid override
  {
...
auto test_plugin::install_gui_nodes(node_factory& gui_factory) -> void
{
  gui_factory.install_node(
    id_gui, "test_gui_node_b", &test_gui_node_b::staticMetaObject,
    documentation::builder("test_gui_node_b").build(),
    [](auto id) { return std::make_shared<test_gui_node_b>("test_gui_node_b", nullptr, id); },
...
auto test_plugin::install_data_nodes(node_factory& data_factory) -> void
{
  data_factory.install_node(
    id_data, "test_data_node_b", &test_data_node_b::staticMetaObject,
    documentation::builder("test_data_node_b").build(),
    [](auto id) {
      return std::make_shared<test_data_node_b>("test_data_node_b", id, types::value_t::CUSTOM,
                                                false);
    },
    [](auto) { return node_factory::node_id_list {}; });
}
...
auto test_plugin::install_communication_nodes(node_factory& communication_factory) -> void
{
  communication_factory.install_node(
    id_communication, "test_communication_node_b", &test_communication_node_b::staticMetaObject,
    documentation::builder("test_communication_node_b").build(),
    [](auto id) {
      return std::make_shared<test_communication_node_b>("test_communication_node_b", id);
    },
    [](auto) { return node_factory::node_id_list {}; });
}
...
auto test_plugin::install_protocol_nodes(node_factory& protocol_factory) -> void
{
  protocol_factory.install_node(
    id_protocol, "test_protocol_node_b", &test_protocol_node_b::staticMetaObject,
    documentation::builder("test_protocol_node_b").build(),
    [](auto id) { return std::make_shared<test_protocol_node_b>("test_protocol_node_b", id); },
    [](auto) { return node_factory::node_id_list {}; });
}
